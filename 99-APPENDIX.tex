...
\Cref{alg:vqe} gives a self-contained description of the VQE procedure as implemented in this project. All source code is available in the project repository \parencite{fys5419-repo}, and the \LaTeX{} report source at \parencite{fys5419-overleaf}.
